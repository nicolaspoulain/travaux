...
;(function(window, document) {
  ...
  var YamlTitle = "Default Title";
  var YamlDate = "1970/01/01";
  Var YamlAuthor = "N. Poulain";

  YamlTitle  = YAML[1].match("title\s*: (.*)")
  YamlDate   = YAML[1].match("date\s*: (.*)")
  YamlAuthor = YAML[1].match("author\s*: (.*)")
