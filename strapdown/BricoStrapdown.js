...
;(function(window, document) {
  ...
  // au dessus mieux http://stackoverflow.com/questions/1068280/javascript-regex-multiline-flag-doesnt-work
  // m = html.search(pattern);
  // return m[1];

  // var YAML = markdown.match("---\n(.*)");


  var patternYaml = /---([\s\S]*?)\.\.\./i
  var YAML = markdown.match(patternYaml);
  var YamlTitle = YAML[1].match("title: (.*)")
  var YamlTags = YAML[1].match("tags: (.*)")
  document.title = YamlTitle[1];
  headlineEl.innerHTML = YamlTags[1];
